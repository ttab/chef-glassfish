...
action :add do
  cached_package_filename = "#{Chef::Config[:file_cache_path]}/#{new_resource.domain_name}_#{Asadmin.component_version(new_resource.version,new_resource.url)}/#{::File.basename(new_resource.url)}"
